...
def runjobs():
    ...
    if cluster=='haba':
        path_2_package='/rigel/theory/users/thn2112/MD_SOM_Gamma'
        ofilesdir = path_2_package + '/Ofiles/'
        resultsdir = path_2_package + '/results/'

    if cluster=='moto':
        path_2_package='/moto/theory/users/thn2112/MD_SOM_Gamma'
        ofilesdir = path_2_package + '/Ofiles/'
        resultsdir = path_2_package + '/results/'

    if cluster=='burg':
        path_2_package='/burg/theory/users/thn2112/MD_SOM_Gamma'
        ofilesdir = path_2_package + '/Ofiles/'
        resultsdir = path_2_package + '/results/'
        
    elif cluster=='axon':
        path_2_package='/home/thn2112/MD_SOM_Gamma'
        ofilesdir = path_2_package + '/Ofiles/'
        resultsdir = path_2_package + '/results/'
        
    elif cluster=='local':
        path_2_package='/Users/tuannguyen/MD_SOM_Gamma'
        ofilesdir = path_2_package+'/Ofiles/'
        resultsdir = path_2_package + '/results/'
    ...
    for j in jvec:
        ...
        #--------------------------------------------------------------------------
        # Make SBTACH      
        inpath = currwd + '/sim_const_eta.py'
        c1 = '{:s} -j {:d} -nrep {:d}'.format(inpath, j, nrep)
        
        jobname='MD_SOM_Gamma-j='+'{:d}'.format(j)
